    ...
    for i = 1:length(test_files)
        ...
        for seg = 1:length(seg_starts_ms)
            ...
            try
                ...
                % 5) 缩放 128×128 (你的代码注释写的64×64，我按你的代码保持不变)
                ...
                if do_show || do_save
                    ...
                    % ★ 魔法指令：中文用宋体，英文切回 Times New Roman
                    ...
                    xlabel('\fontname{SimSun}像素列'); 
                    ylabel('\fontname{SimSun}像素行');
                    % \times 在 TeX 解释器里会输出标准的数学乘号
                    title('\fontname{Times New Roman}4. \fontname{SimSun}最终输入 \fontname{Times New Roman}(64 \times 64)');
                    set(ax4, 'XColor','r', 'YColor','r', 'LineWidth', 2);

                    % 批注框全是参数，强行指定为 Times New Roman
